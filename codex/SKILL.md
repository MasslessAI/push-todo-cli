...
```bash
source ~/.config/push/config && python3 ~/.codex/skills/push-tasks/scripts/fetch_task.py
```
...
1. Mark it as started:
   ```bash
   python3 ~/.codex/skills/push-tasks/scripts/fetch_task.py --mark-started TASK_ID
   ```
...
```bash
python3 ~/.codex/skills/push-tasks/scripts/fetch_task.py --mark-completed TASK_ID
```
...
1. Run the setup script:
   ```bash
   python3 ~/.codex/skills/push-tasks/scripts/setup.py
   ```
